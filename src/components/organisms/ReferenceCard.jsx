        ...
        <div className="flex-1">
          <div className="flex items-center space-x-3 mb-2">
            <div className="flex items-center justify-center h-8 w-8 rounded-lg bg-surface-100">
              <ApperIcon name={getTypeIcon(reference.type)} className="h-5 w-5 text-surface-600" />
            </div>
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-surface-900">
                {reference.title}
              </h3>
              <Badge variant={getTypeVariant(reference.type)} className="mt-1">
                {reference.type}
              </Badge>
            </div>
          </div>
